...
public class ClassPaneBigController {
	...
	public boolean isInputValid() {
		...
		if (idTeacherField.getText().isEmpty()) {
			errorMessage += "Debes ingresar el código del profe Crisi\n";
		}
		if (nameClassField.getText().isEmpty()) {
			errorMessage += "Debes ingresar el nombre de la clase Crisi\n";
		}
		if (dayOneField.getText().isEmpty()) {
			errorMessage += "Debes ingresar el día uno Crisi\n";
		}
		if (startHour1Field.getText().isEmpty()) {
			errorMessage += "Debes ingresar la hora de inicio de clase del día 1 Crisi\n";
		}
		if (endHour1Field.getText().isEmpty()) {
			errorMessage += "Debes INgresar la hora de final de clase del día 1 Crisi\n";
		}
		if (secondDayField.getText().isEmpty()) {
			errorMessage += "Debes ingresar el segundo día Crisi\n";
		}
		if (startHour2Field.getText().isEmpty()) {
			errorMessage += "Debes ingresar la hora de inicio de clase del día 2 Crisi\n";
		}
		if (endHour2Field.getText().isEmpty()) {
			errorMessage += "Debes ingresar la hora de final de clase del día 2 Crisi\n";
		}
