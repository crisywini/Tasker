...
public class Admin extends DBConnection implements AdminRemote {
	...
	public void addStudentToClass(int idClass, int idStudent) throws EntityNullException, EntityRepeatexception {
		...
		if (student == null) {
			throw new EntityNullException("El estudiante no está registrado Crisi");
		}
		if (classR == null) {
			throw new EntityNullException("La clase no está registrada Crisi");
		}
		if (getStudentsByClass(idClass).isEmpty()) {
			...
			throw new EntityRepeatexception("El estudiante: " + idStudent + " ya está registrado en esa clase Crisi");
		}
	...
	public void setTeacherToClass(int idTeacher, int idClass) throws EntityNullException {
		...
		if (classR == null || teacher == null) {
			throw new EntityNullException("Alguna de las entidades no está registrada Crisi");
		}
	...
	public Student getStudentById(int idStudent) throws EntityNullException {
		...
		if (student == null) {
			throw new EntityNullException("El estudiante con: " + idStudent + " no está registrado");
		}
		return student;
	}
	...
	public Class getClassByIdTeacher(int idTeacher) throws EntityNullException {
		...
		if (classRequested == null) {
			throw new EntityNullException("La clase con el profe: " + idTeacher + " no está registrada Crisi");
		}
		return classRequested;
	}
	...
	public Student getStudentByName(String name) throws EntityNullException {
		...
		if (student == null) {
			throw new EntityNullException("El estudiante: " + name + " no está registrado Crisi");
		}
		return student;
	}
	...
	public int countStudentInClass(int idStudent, int idClass) throws EntityNullException {
		...
		if (student == null) {
			throw new EntityNullException("El estudiante: " + idStudent + " no está resgitrado Crisi");
		}
		int out = 0;
